...
3. Using the interest rates from Part 1, calculate the firm's **all-in annual interest cost** (in USD terms) under the hedged position: assume the firm borrows at the foreign rate $r_f$, converts the proceeds at the spot rate, and has locked in repayment of the principal at the forward rate. Compare this to simply borrowing at the domestic rate $r_d$. Is the result consistent with CIP? Explain why or why not.
