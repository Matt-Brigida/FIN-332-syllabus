...
**Class Location**:  *Hybrid*, KUNSHL A135.
...
Your application should have something to do with currency markets, and should be at least somewhat original.  See this [gallery of applications](http://shiny.rstudio.com/). Possible applications may be:
